...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-AR">
	...
	<header style="margin-left:10px;margin-right:10px;">
		<img src="img/azteca.png" class="img-responsive" alt="Image" style="width:100px;height:100px;float: left">
		<h1 style="height:100px;padding-top:30px;margin-left:124px;">Reportes de Pagos</h1>
	...
	<div id="container-dia" style="margin-left:10px;margin-right:10px;">
		...
		<div class="well" style="width:450px;">
		  ...
		  <form action="classes/exportExcelDia.php" method="post" target="_blank" id="FormularioExportacionDia" style="margin-bottom:0px">
			<button type="button" id="botonExcelDia" class="btn btn-sm btn-default"  style="margin-left:30px;margin-top:-6px;">Export Excel</button>
	...
	<div id="container-mes" style="margin-left:10px;margin-right:10px;display:none;">
		...
		<br/><br/><div>Hasta: </div>
		  ...
		  <form action="classes/exportExcelMes.php" method="post" target="_blank" id="FormularioExportacionMes" style="margin-bottom:0px">
			<button type="button" id="botonExcelMes" class="btn btn-sm btn-default" style="margin-left:30px;margin-top:-6px;">Export Excel</button>
	...
	<div id="container-anual" style="margin-left:10px;margin-right:10px;display:none;">
		...
		<div class="well" style="width:450px;">
		  ...
		  <form action="classes/exportExcelAnual.php" method="post" target="_blank" id="FormularioExportacionAnual" style="margin-bottom:0px">
			<button type="button" id="botonExcelAnual" class="btn btn-sm btn-default"  style="margin-left:30px;margin-top:-6px;">Export Excel</button>
			<input type="hidden" id="datos_a_enviar_anual" name="datos_a_enviar_anual" />
		  </form>
		</div>
		<h1 id='error' style="display:none;">No se encontraron resultados.</h1>
		<div style="width:900px;">
