...
<div class="header container">
  ...
  <nav class="nav-section">
 	<div class="container">
 	<div class="row">
  		<h2 class="pull-left"><span>Últimos</span> Eventos</h2>
  		<div class="btn-group btn-group-sm pull-right">
  		  <button type="button" class="btn btn-default btn-lg btn-ver-ultimos" style="font-size:20px;" > Ver Últimos</button>
  		  <button type="button" class="btn btn-default btn-lg btn-ver-todos" style="font-size:20px;" > Ver todos</button>	
  ...
  <nav class="footer " role="navigation">
  	<div class="container">
	  <div class="row">
     <span>&copy; 2014 ESCUELA AZTLAN - Almagro, Ciudad Autónoma de Buenos Aires, Argentina - <a href="mailto:info@aztlan.com.ar">info@aztlan.com.ar</a> - 4981-0592/2442</span>
