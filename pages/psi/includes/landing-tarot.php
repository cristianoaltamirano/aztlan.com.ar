	...
	<div class="container">
	  <div class="row">
	    <div class="main-text col-md-10 col-md-offset-1 col-sm-12">
	      ...
	      <h9 class="text-left sub-titulos3">Enfoque según la Psicología de Carl G. Jung - 8 Jornadas (con opci&oacute;n a 4 jornadas)</h9>
	      <br />
	      <div class="beneficios">
	        <h10 class="text-left sub-titulos5"> Claves para interpretar los símbolos de las cartas desde el punto de vista psicológico. EL Tarot como un mapa, que describe el viaje hacia la autorrealización. 
</h10>
          </div>
	      <div class="beneficios">
	    ...
	    <div class="main-text col-md-10 col-md-offset-1 col-sm-12">
	      <div class="beneficios">
	        <h10 class="text-left sub-titulos4">4 jornadas de 1 h. 30 m. y luego podés hacer 4 más
</h10>
	        <h10 class="text-left sub-titulos2">Días de las 4 jornadas: Lunes 19 hs. (4 Jueves de Enero o Febrero)</h10>
          </div>
        </div>
      </div>
	</div>
