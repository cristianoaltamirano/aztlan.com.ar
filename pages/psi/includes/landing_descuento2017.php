...
<html lang="">
    ...
    <body class="psico" margin="0">
        ...
        <div class="container" id="contenedor">
            ...
            <!--   BEGIN CONTENTS    -->
            <div class="visible-md visible-sm visible-lg " id="contents3" style="background-image:url('../../../images/eventos/landing/<?php echo $evento->idEvento?>.jpg') !important">
                ...
                <?php include('site/includes/form_fb2017desc.php');?>
           ...
           <!-- 
            ...
            <div class="visible-xs" id="mobile-contents">
                ...
                <?php include('site/includes/mobile-form_fb2017desc.php');?>
