...
<meta property="og:url" content="http://aztlan.org.ar/landing/psi/#/c/237/2" />
<meta property="og:title" content="Psicolog&#237;a Transpersonal: Charla Gratuita - Almagro"/>
<meta property="og:image" content="http://aztlan.org.ar/landing/images/facebook/facebook-junio-3.jpg"/>
<meta property="og:site_name" content="Escuela de conocimiento integral"/>
<meta property="og:description" content="En esta charla introduciremos las tÃ©cnicas y herramientas que brindan los mÃ©todos de psicologÃ­a transpersonal.Acercate ya y conocÃ© cÃ³mo el aprendizaje de estos mÃ©todos te van a ayudar a transformar las emociones negativas." />
...
<link href="site/css/estilos.css" rel="stylesheet">
...
<div class="header-mobile container visible-xs visible-sm">
    <div class="row">    
		...
		<!--   BEGIN CONTENTS    -->
		<div id="contents" class="cc">
		<div class="entrar"><a href="http://www.aztlan.org.ar/es/">Entrar al sitio web</a></div>
		<div class="clearfix"></div>
				
		<div class="fecha"><span class="txt-fecha">Miércoles 16 de Julio</span> 17:00 hs.
		</br><span class="lugar">En Centro Cultural Sr. Duncan / Av. Rivadavia 3832, Almagro, C.A.B.A.</span>
		</div>
		<div class="promo">
			<h3 class="intro" >Charla Gratuita de</h3>
			<h1 class="titulo" >Cuarto Camino / C. G. Jung / Budismo</h1>					
			<h4 class="metodo" >Psicología Transpersonal</h4>					
			<!--<h4 class="metodo" >Método: C. G. Jung / Cuarto Camino / Budismo / Hinduismo / Yoga</h4>				-->
		</div>
		
		<div class="frase big">
			<h4>Claves para el Autoconocimiento y el Desarrollo Personal</h4>
		</div>
		<img class="hidden-lg hidden-md img-responsive" src="images/cc.jpg" />
		</div>
		<!--   END CONTENTS    -->
  ...
  <div class="container">
   <span>&copy; 2014 ESCUELA AZTLAN - Almagro, Ciudad Autónoma de Buenos Aires, Argentina - <a href="mailto:contacto@aztlan.org.ar">contacto@aztlan.org.ar</a> 4981-0592 /  15-6378 - 5701</span>
  </div>
  </nav>
