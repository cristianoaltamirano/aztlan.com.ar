...
// start -> ../sources/assets/funciones.js **************************************************
...
// end -> ../sources/assets/funciones.js **************************************************

// start -> ../sources/assets/libs/underscore.js **************************************************
//     Underscore.js 1.5.2
...
// end -> ../sources/assets/libs/underscore.js **************************************************

// start -> ../sources/assets/libs/jquery-1.10.2.min.js **************************************************
...
// end -> ../sources/assets/libs/jquery-1.10.2.min.js **************************************************

// start -> ../sources/assets/libs/backbone.js **************************************************
//     Backbone.js 1.1.0
...
// end -> ../sources/assets/libs/backbone.js **************************************************

// start -> ../sources/assets/libs/plugins/extenciones.js **************************************************
...
// end -> ../sources/assets/libs/plugins/extenciones.js **************************************************

// start -> ../sources/assets/libs/plugins/jquery.base64.js **************************************************
/*!
...
// end -> ../sources/assets/libs/plugins/jquery.base64.js **************************************************

// start -> ../sources/assets/libs/plugins/jquery.validate.min.js **************************************************
/**
...
// end -> ../sources/assets/libs/plugins/jquery.validate.min.js **************************************************

// start -> ../sources/assets/libs/plugins/toastr.min.js **************************************************
...
// end -> ../sources/assets/libs/plugins/toastr.min.js **************************************************

// start -> ../sources/assets/Application.js **************************************************
(function(w) {
...
// end -> ../sources/assets/Application.js **************************************************

// start -> ../sources/assets/core/Address.js **************************************************
app.Address = {
...
// end -> ../sources/assets/core/Address.js **************************************************

// start -> ../sources/assets/core/Logger.js **************************************************
(function(app) {
...
// end -> ../sources/assets/core/Logger.js **************************************************

// start -> ../sources/assets/data/DataController.js **************************************************
(function(app) {
...
// end -> ../sources/assets/data/DataController.js **************************************************

// start -> ../sources/assets/data/PersistentData.js **************************************************
(function(app) {
...
// end -> ../sources/assets/data/PersistentData.js **************************************************

// start -> ../sources/assets/data/Request.js **************************************************
(function(app) {
...
// end -> ../sources/assets/data/Request.js **************************************************

// start -> ../sources/mvc/model/appModel.js **************************************************
...
// end -> ../sources/mvc/model/appModel.js **************************************************

// start -> ../sources/mvc/model/hashModel.js **************************************************
...
// end -> ../sources/mvc/model/hashModel.js **************************************************

// start -> ../sources/mvc/model/modalModel.js **************************************************
...
// end -> ../sources/mvc/model/modalModel.js **************************************************

// start -> ../sources/mvc/model/SectionManagerModel.js **************************************************
		...
		if(sname == this.sname)
			{
				if(this.section.model){
					//this.section.model.set('route',route);
					//this.section.model.set('params',params);
...
// end -> ../sources/mvc/model/SectionManagerModel.js **************************************************

// start -> ../sources/mvc/model/sectionModel.js **************************************************
...
// end -> ../sources/mvc/model/sectionModel.js **************************************************

// start -> ../sources/mvc/view/app.View.js **************************************************
app.View = Backbone.View.extend({

});
// end -> ../sources/mvc/view/app.View.js **************************************************

// start -> ../sources/mvc/view/app.Section.js **************************************************
...
// end -> ../sources/mvc/view/app.Section.js **************************************************

// start -> ../sources/mvc/view/app.viewController.js **************************************************
/*app.viewController = {
	sections:[],
	sname:'',//currentSectionName
	section:null,//currentSection
...
// end -> ../sources/mvc/view/app.viewController.js **************************************************

// start -> ../sources/app/view/form-mobile.js **************************************************
...
// end -> ../sources/app/view/form-mobile.js **************************************************

// start -> ../sources/app/view/form.js **************************************************
...
// end -> ../sources/app/view/form.js **************************************************

// start -> ../sources/app/model/FormModel.js **************************************************
app.data.models.FormModel = app.models.Model.extend({
        ...
        if(params['checkbox[]']){
          var a = params['checkbox[]'];
          params.intereses = '';
          a.forEach(function(entry) {
              params.intereses += entry + " - ";
          });
          delete params['checkbox[]'];
    		...
    		this.url.camp.insertCamp({params:params,evento:evento,owner:owner,source:source},function(data){
    			...
    			//if(data.email == true){
    			//alert(params.facebook);
          //alert(params.desde);

          //console.log('entre' + params.facebook);
          if(params.facebook)
          {
            if(params.desde == 'psico')
            {
              /*if(params.dni < 28000000 || params.dni > 42000000 )
              {
                if (params.tipoform == 'charla') 
                {
                  window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_charla.html';
                }else
                {
                  window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_entrevista.html';   
                }
              }else
              {
                window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb.html';
              }*/
              
              //window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb.html';
              window.location = 'http://aztlan.org.ar/autoreply.php';
            }else if(params.desde == 'astro')
            {
              /*if(params.dni < 14000000 || params.dni > 42000000 )
              {
                if (params.tipoform == 'charla') 
                {
                  window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_charla.html';
              ...
              {
                window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_astro.html';
              }*/
              //window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_astro.html';
              window.location = 'http://centroastrologico.com.ar/gracias.php';
              
            }/*else if(params.desde == 'tarot')
            {
              window.location = 'http://aztlan.com.ar/blog/consultas/site/autoreply/autoreply_fb_tarot.html';
            }else
            {
              window.location = 'http://www.aztlan.com.ar/entrevistas/site/autoreply/autoreply_fb.html';
            }*/
...
// end -> ../sources/app/model/FormModel.js **************************************************

// start -> ../sources/app/utils/Utils.js **************************************************
Utils = {
...
// end -> ../sources/app/utils/Utils.js **************************************************

// start -> ../sources/app/utils/Validation.js **************************************************
var Validation = {};
...
// end -> ../sources/app/utils/Validation.js **************************************************

// start -> ../sources/app/app.js **************************************************
