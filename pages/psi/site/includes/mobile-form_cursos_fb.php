<div class="col-xs-12  visible-xs visible-sm">
  <div  class="form-mobile">
    ...
    <div class="seleccion" style="color: white;">
      ...
      <div class="row">
        <div class="col-sm-6">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" value="Psicología Holística" name="checkbox[]">
            Psicología Holística
          </label>
        </div>
        <div class="col-sm-6">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" value="Astrología" name="checkbox[]">
            Astrología
          </label>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" value="Tarot" name="checkbox[]">
            Tarot
          </label>
        </div>
      </div>
      ...
      <!--    </div> -->
      <div class="form-group">
        <button class="btnSend mobile btn btn-warning btn-lg">Solicitar m&aacute;s Info</button>
      </div>
    </form>
  </div>
</div>